...
public class LoginScene {
    ...
    public void show() {
        ...
        Label labelHello = UIUtil.createLabel("Sign in to your account", 475, 93);
        ...
        Label labelStatus = UIUtil.createLabel("", 500, 353);
        labelStatus.getStyleClass().add("label-status");

        ImageView imageViewSkillup = UIUtil.createImageView("/images/imageLogin.png", 300, 405, 39, 37);
