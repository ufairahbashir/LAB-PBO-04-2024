...
public class SplashScreen {
    ...
    public void show() {
        ...
        ImageView splashImageView = UIUtil.createImageView("/images/logoPeejar2.png", 100, 100, 316, 152);
        splashImageView.getStyleClass().add("image-skillup");

        Label titleText = UIUtil.createLabel("Peejar", 322, 262); // Initial X,Y will be adjusted later
        titleText.getStyleClass().add("title-text-splash");

        // Set background image
        BackgroundImage backgroundImage = UIUtil.createBackgroundImage("/images/LandingPeejar.png", 740, 480);
