public class HotWheels1 {
    ...
    //TODO 1 : Create a constructor according to your needs in
    public HotWheels1(String name, double speed, double cash, int winningAmount) {
        this.name = name;
        this.speed = speed;
        this.cash = cash;
    ...
    public void raceTo(HotWheels1 enemy) {
