...
public class Main {
    ...
    private static void showLoginMenu() {
        ...
        if (userIndex != -1) {
             ...
             */
            boolean isPasswordMatch = listUser.get(userIndex).equals(password);
    ...
    private static void showDetailUser(Profile profile) {
        ...
        System.out.println("Nama Lengkap"+ profile.getNickName());
        System.out.println("Nama Lengkap"+ profile.getUmur());
        System.out.println("Nama Lengkap"+ profile.getHobby());
    }
}